...
const threeOfKind = new SumDistro({ count: 3 , description: "Total of all dice if 3 are the same" });
const fourOfKind = new SumDistro({ count: 4 , description: "Total of all dice if 4 are the same" });

// full house scores as flat 25
const fullHouse = new FullHouse({score: 25, description: "25 points for a full house" });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({score: 30 , description: "30 points for a run of 4" });
const largeStraight = new LargeStraight({ score: 40 , description: "40 points for a run of 5" });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50 , description: "50 points when all dice are the same" });
